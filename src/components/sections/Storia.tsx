        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Card className="bg-white border-none shadow-xl hover:shadow-2xl transition-all duration-500 rounded-[32px] overflow-hidden flex flex-col group">
            ...
            <CardContent className="p-8 md:p-10 space-y-6 flex-1 flex flex-col">
              ...
              <Button asChild className="w-full bg-[var(--steel)] hover:bg-[var(--steel)]/90 text-white rounded-[16px] py-4 h-auto text-sm font-black uppercase tracking-[0.1em] shadow-lg shadow-blue-900/10 transition-all hover:scale-[1.02] active:scale-95 mt-6">
          ...
          <Card className="bg-white border-2 border-[var(--brand)] shadow-2xl hover:shadow-2xl transition-all duration-500 rounded-[32px] overflow-hidden flex flex-col group relative">
            ...
            <CardContent className="p-8 md:p-10 space-y-6 flex-1 flex flex-col">
              ...
              <Button asChild className="w-full bg-[var(--brand)] hover:bg-[var(--brand)]/90 text-white rounded-[16px] py-4 h-auto text-sm font-black uppercase tracking-[0.1em] shadow-lg shadow-orange-900/10 transition-all hover:scale-[1.02] active:scale-95 mt-6 border-none">
                <Link href="/login" className="flex items-center gap-2 justify-center">
                  Voglio essere guidata <ArrowRight className="w-4 h-4" />
                </Link>
              </Button>
            </CardContent>
          </Card>
