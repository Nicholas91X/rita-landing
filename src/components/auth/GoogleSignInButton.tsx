...
export function GoogleSignInButton({ termsAccepted, mode }: Props) {
  ...
  return (
    <button
      ...
      className="w-full h-12 rounded-2xl bg-white text-neutral-900 font-bold text-sm flex items-center justify-center gap-3 border border-neutral-200 hover:bg-neutral-50 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
    >
