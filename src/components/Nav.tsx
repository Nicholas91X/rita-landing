    ...
    <header className="sticky top-0 z-50 border-b bg-[var(--steel)] text-white backdrop-blur">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-2">
        ...
        <div className="h-16 md:h-20 flex items-center justify-between gap-3">
          ...
          {/* Socials desktop */}
          <Socials variant="light" className="hidden md:flex" />
...
-+               bg-[var(--primary)] text-[var(--primary-foreground)] hover:opacity-90 border-1 border-black hidden sm:inline-flex rounded-full"
        ...
        {/* riga social mobile sotto la principale */}
        <div className="mt-1 mb-2 md:hidden flex justify-center">
          <Socials variant="light" size={40} />
        </div>
      </div>
    </header>
  );
